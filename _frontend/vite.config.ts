...
// The Programs page (public/programs.html) is the migrated hand-written Stage-1 page,
// copied verbatim from publicDir along with its data/. Entry point is /programs.html.
