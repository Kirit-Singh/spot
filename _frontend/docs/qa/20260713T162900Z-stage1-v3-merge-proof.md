...
preserved untouched). Branch's 01_programs/app/programs.html now byte-identical to served
_frontend/public/programs.html (570a6f07, v3). No scientific artifact or hash changed.
...
| no v1 emission/read | ✅ served programs.html: v3 key present, **zero** setItem(...v1); v1 never written |
