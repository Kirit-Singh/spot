...
import { TraceView } from '../mpa/methodsViews';
...
createRoot(document.getElementById('root')!).render(
  <PageShell page={stage} subtitle={`${label} · Provenance`} selection={sp.selection} methodsProvenance={sp.provenance}>
    <TraceView stage={stage} provenance={sp.provenance} selection={sp.selection} />
  </PageShell>,
);
