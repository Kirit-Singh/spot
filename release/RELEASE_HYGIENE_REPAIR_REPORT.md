...
| Scanner files could hide a credential | No tracked file is excluded from secret scanning, including the scanner, allowlist and release policy. | A credential-shaped value in the staged allowlist snapshot is detected by name. No credential value is stored in this report or repository. |
...
- Ensembl-cache provenance: `7cba971c…` →
